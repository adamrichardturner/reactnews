...
const Health: NextPage<IArticlesProps> = ({articles}) => {
  return (
    <div>
      <Head>
        <title>ReactNews | Health</title>
        <meta name="description" content="Find out the latest health news from over 60,000 sources." />
        ...
        <meta property="og:title" content="ReactNews | Health" />
        <meta
        ...
        <meta name="twitter:title" content="ReactNews | Health" />
...
export const getServerSideProps = async () => { 
  const endpoint='top-headlines', topic='health';
