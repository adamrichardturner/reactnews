  ...
  return (
    <div>
      <Head>
        ...
        <meta name="description" content="Featuring articles on Entertainment brought to you from all over the world." />
        ...
        <meta property="og:title" content="ReactNews | Entertainment" />
        <meta
        ...
        <meta name="twitter:title" content="ReactNews | Entertainment" />
